<nav class="bg-blue-900  border-gray-200 px-2 sm:px-12 py-2.5 dark:bg-gray-900">
        ...
        <button data-collapse-toggle="navbar-default"  class="inline-flex items-center p-2 ml-3 text-sm text-light-500 rounded-lg md:hidden hover:bg-gray-100   ">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="flex flex-col p-5 mt-5 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm  md:border-0  ">
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white md:hover:text-blue-700 rounded  md:p-0 dark:text-white" >Home</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 pl-3 pr-4 text-white md:hover:text-blue-700 rounded md:p-0 dark:text-gray-400  ">About</a>
                    </li>
                    {{-- <li>
                    <a href="#" class="block py-2 pl-3 pr-4 text-white md:hover:text-blue-700 rounded md:p-0 dark:text-gray-400 ">Student</a>
                    </li> --}}
                    <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white">
                        Student
                    </button>
                    <!-- Dropdown menu -->
                    ...
                    <li>
                        <a href={{ route('admin.login') }} class="block py-2 pl-3 pr-4 text-white md:hover:text-blue-700 rounded md:p-0 dark:text-gray-400 ">Admin</a>
                    </li>
                </ul>
            </div>
    </div>
