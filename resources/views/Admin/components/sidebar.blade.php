<aside id="logo-sidebar" class="sidebar fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full sm:translate-x-0 bg-blue text-white" aria-label="Sidebar">
  <div class="h-full px-3 pb-4 overflow-y-auto bg-blue">
     <ul class="space-y-2">
        ...
        <li>
          <a href="{{ route('admin.students_list') }}" class="{{ (request()->is('admin/students_list', 'admin/create_studentForm', 'admin/edit_student/*')) ? 'active' : '' }} hover:bg-redpink  flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <li>
          <a href="{{ route('admin.course_list') }}" class="{{ (request()->is('admin/course_list', 'admin/create_courseForm', 'admin/edit_course/*')) ? 'active' : '' }} hover:bg-redpink flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <li>
          ...
          <ul id="subjects" class="hidden py-2 space-y-2">
            ...
            <li>
              <a href="{{ route('admin.subject_combination_list') }}" class="{{ (request()->is('admin/subject_combination_list', 'admin/create_subject_combination', 'admin/edit_subject_combination/*')) ? 'active' : '' }} hover:bg-redpink flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
        ...
        <li>
           <a href="{{ route('admin.notice_list') }}" class="{{ (request()->is('admin/notice_list', 'admin/create_noticeform', 'admin/editNotice/*')) ? 'active' : '' }} hover:bg-redpink flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
        ...
        <li>
          ...
          <ul id="settings" class="hidden py-2 space-y-2">
            <li>
              <a href="{{ route('admin.change_password') }}" class="{{ (request()->is('admin/change_password')) ? 'active' : '' }} hover:bg-redpink flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
